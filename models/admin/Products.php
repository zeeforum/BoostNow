...
class Products extends ActiveRecord {
	...
	public function rules() {
		return [
			...
			['cut_price', 'number', 'message' => 'Please Enter Valid Cut Price', 'on' => self::SCENARIO_ACTION],
			['cut_price_type', 'in', 'range' => ['value', 'percentage'], 'message' => 'Please Select Cut Price Type', 'on' => self::SCENARIO_ACTION],
